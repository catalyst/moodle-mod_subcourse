...
$navlinks = array();
$navlinks[] = array('name' => $strsubcourses, 'link' => "index.php?id=$course->id", 'type' => 'activity');
$navlinks[] = array('name' => format_string($subcourse->name), 'link' => '', 'type' => 'activityinstance');

$navigation = build_navigation($navlinks);

print_header_simple(format_string($subcourse->name), "", $navigation, "", "", true,
              update_module_button($cm->id, $course->id, $strsubcourse), navmenu($course, $cm));

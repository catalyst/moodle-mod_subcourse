...
$string['settings:coursepageprintgradedesc'] = 'Display grade from referenced course on course page';
$string['settings:coursepageprintprogress'] = 'Progress on course page';
$string['settings:coursepageprintprogressdesc'] = 'Display progress from referenced course on course page';
